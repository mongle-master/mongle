    ...
    step === 'name' ? (
      <>
        ...
        <Input
          ...
          autoFocus
          enterKeyHint="next"
          className="mt-10 h-14 rounded-none border-0 border-b border-border bg-transparent px-1 text-2xl font-medium shadow-none focus-visible:ring-0 md:text-2xl"
        />
      </>
    ) : step === 'relation' ? (
      <>
