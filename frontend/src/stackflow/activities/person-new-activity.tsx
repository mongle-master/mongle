...
export const PersonNewActivity: ActivityComponentType<'PersonNew'> = () => {
  ...
  const stepBody =
    step === 'name' ? (
      <>
        <h2 className="font-display text-2xl font-light">누구를 남길까요?</h2>
        ...
        <Input
          ...
          autoFocus
          enterKeyHint="next"
          className="mt-10 h-14 rounded-none border-0 border-b border-border bg-transparent px-1 font-display text-2xl font-light shadow-none focus-visible:ring-0 md:text-2xl"
        />
      </>
    ) : step === 'relation' ? (
      <>
        <h2 className="font-display text-2xl font-light">어떤 사이예요?</h2>
