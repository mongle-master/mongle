  ...
  return createPortal(
    ...
    >
      <button
        type="button"
        className={cn(
          'absolute inset-0 bg-foreground/40 transition-opacity duration-200 ease-out starting:opacity-0',
      ...
      <div
        ...
        className={cn(
          'relative w-full max-w-sm rounded-2xl border border-border bg-card p-5 text-card-foreground shadow-e3 outline-none',
