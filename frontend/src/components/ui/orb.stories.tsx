...
import { Orb } from './orb'
import type { OrbEmotion } from './orb'
...
const EMOTION_LABEL: Record<OrbEmotion, string> = {
  calm: '고요',
  warm: '따뜻',
  muse: '사색',
  clear: '맑음',
...
export const FiveFamilies: Story = {
  render: () => (
    <div className="flex flex-wrap gap-8">
      {(Object.keys(EMOTION_LABEL) as OrbEmotion[]).map((emotion) => (
...
export const Atmospheric: Story = {
  render: () => (
    <div className="relative flex h-64 w-full items-center justify-center overflow-hidden rounded-2xl bg-background">
      ...
      />
      <p className="relative font-display text-display-lg font-light">
        오늘은 어떤 하루였나요?
      </p>
    </div>
  ),
