...
// badge.tsx가 이 문자열 위에 cva를 얹는다(부품 합성 선례). 배지와 칩이 공유하는
// 시각 계약이다. lovable.dev 실측 문법에 맞춰 굵기를 font-bold에서 font-medium으로
// 완화한다(Lovable은 칩/라벨에 중간 굵기를 쓴다).
  ...
  'group/tag-chip inline-flex w-fit shrink-0 items-center justify-center gap-1.5 rounded-full border border-transparent leading-none whitespace-nowrap transition-colors',
  {
    variants: {
      ...
      size: {
        ...
        default: 'h-7 px-3.5 text-label font-medium',
        lg: 'h-8 px-2.5 text-label font-medium',
