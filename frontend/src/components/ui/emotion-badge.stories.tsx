...
export const Joy: Story = { args: { emotion: 'joy' } }
export const Calm: Story = { args: { emotion: 'calm' } }
export const Sadness: Story = { args: { emotion: 'sadness' } }
export const Anger: Story = { args: { emotion: 'anger' } }
export const Anxiety: Story = { args: { emotion: 'anxiety' } }
export const Gratitude: Story = { args: { emotion: 'gratitude' } }
