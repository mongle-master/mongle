    ...
    <div data-slot="dialog-root" className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <button
          ...
          onClick={onClose}
          aria-label="닫기"
          className="absolute right-4 top-4 rounded-full p-1 text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-2 focus-visible:outline-ring active:scale-95"
        >
          <X className="h-4 w-4" />
        </button>
      </div>
